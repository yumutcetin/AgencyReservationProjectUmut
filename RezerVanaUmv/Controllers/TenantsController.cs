...
namespace RezerVanaUmv.Controllers
{
    ...
    public class TenantsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Subdomain,ContactEmail,LogoUrl,IsActive,CreatedAt")] Tenant tenant)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Subdomain,ContactEmail,LogoUrl,IsActive,CreatedAt")] Tenant tenant)
        {
            if (id != tenant.Id)
            {
                return NotFound();
